...
return array(
    ...
    */
    'default_format'                        => array(
        ...
        'default'               => '<div class="alert alert-:type alert-dismissible" role="alert">:message<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>',
    ...
    */
    'default_formats'                       => array(
        ...
        'default'               => array(
            'error'             => '<div class="alert alert-danger alert-dismissible" role="alert">:message<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>'
        ),
