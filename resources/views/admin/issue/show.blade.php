...
<h1>
	...
	{!! Form::open(['url' => '/admin/issue/delete/', 'class' => 'pull-right']) !!}
		<input type="hidden" name="id" value="{{ $issue->id }}">
		<button type="submit" class="btn btn-xs btn-link text-danger" onclick="return confirm('Confirma excluir?');"><i class="icon-trash"></i> Excluir problema</button>
	{!! Form::close() !!}
</h1>
<hr>
